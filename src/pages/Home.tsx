    ...
    <div>
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div className="flex-1 flex gap-2">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg flex items-center gap-2 transition whitespace-nowrap ${isGlobalSearch ? 'bg-orange-500 text-white' : 'bg-gray-100 dark:bg-gray-800 text-gray-500'}`}
            title="集合全站资源搜索"
          >
            <Globe size={18} /> {isGlobalSearch ? '全站搜索' : '单站搜索'}
          </button>
        </div>
      ...
      {!showHistory && !isGlobalSearch && (
        <div className="flex items-center gap-4 mb-4">
          ...
          <select
            className="bg-gray-100 dark:bg-gray-800 border-none rounded px-3 py-1.5 text-sm outline-none focus:ring-2 focus:ring-blue-500 dark:text-white"
